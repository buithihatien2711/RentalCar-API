...
namespace RentalCar.Data.Seed
{
    public class Seed
    {
        ...
        public static void SeedLocation(DataContext context)
        {
            ...
            var locationText = System.IO.File.ReadAllText("D:/DUT/PBL6_GopCode/RentalCar-API/RentalCar.Data/Seed/Location.json");
        ...
        public static void SeedModelBrand(DataContext context)
        {
            ...
            var modelText = System.IO.File.ReadAllText("D:/DUT/PBL6_GopCode/RentalCar-API/RentalCar.Data/Seed/ModelBrand.json");
        ...
        public static void SeedUser(DataContext context)
        {
            ...
            var usersText = System.IO.File.ReadAllText("D:/DUT/PBL6_GopCode/RentalCar-API/RentalCar.Data/Seed/User.json");
